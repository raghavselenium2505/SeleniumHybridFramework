...
import com.seleapi.ai.AIRetryAnalyzer;
import com.seleapi.base.TestBase;
import com.seleapi.dataprovider.DynamicDataProvider;
import com.seleapi.utils.WaitUtils;
import com.seleapi.listeners.TestListener;
import com.seleapi.pages.MilkMan_ChooseYourPlanPage;
import com.seleapi.pages.MilkMan_DeliveryDetailPage;
import com.seleapi.pages.MilkMan_HomePage;
import com.seleapi.pages.MilkMan_LoginPage;
import com.seleapi.pages.MilkMan_PaymentPage;
import com.seleapi.pages.MilkMan_SignUpPage;
import com.seleapi.pages.MilkMan_YourBasketPage;
import com.seleapi.base.TestBase;
import com.seleapi.dataprovider.DynamicDataProvider;
import com.seleapi.utils.WaitUtils;

public class MilkManSignupAnnuallyTest extends TestBase {
	...
	@Test(
		    ...
		    public void MilkManLoginWithAnnually(Map<String, String> data) {
			...
			try {
				...
				actionclick(getDriver().findElement(chooseyourplan.radioButtonAnnual), "Able to click on Annual plans",
						"Unable to click on Annual plans");
				waitforelement(1000);
				click(chooseyourplan.buttonCheckOut, "Able to click on checkout", "Unable to click on checkout page");

				waitforelement(1000);
				verifyElementDisplayed(chooseyourplan.textWelcomeRound, "Able to display the chooseyourplan",
						"Unable to display the chooseyourplan");

				click(chooseyourplan.buttonOkay, "Able to click on buttonOkay", "Unable to click on buttonOkay");
				waitforelement(1000);
	...
	public void executeBotTest(
	    ...
	    try {
	        ...
	        Method method =
	                this.getClass()
	                .getMethod(
	                "MilkManLoginWithAnnually",
	                Map.class);

	        setUp("", "", method);

	        MilkManLoginWithAnnually(data);
